  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      ...
      >
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-2 sm:gap-6 lg:gap-8 ipadpro:grid-cols-2 ipadpro-landscape:grid-cols-2 ipadpro:gap-4 ipadpro-landscape:gap-6">
          {isLoading ? (
