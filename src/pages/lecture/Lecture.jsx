...
const Lecture = ({ user }) => {
  ...
  const handleSubmitLecture = async (e) => {
    ...
    if (video) formData.append('file', video); // Matches backend expectation

    try {
      console.log('Submitting lecture with data:', { title, description, video: video ? 'Video selected' : 'No video' });
      ...
      const errorMsg = error.response?.data?.message || 'An error occurred while adding the lecture.';
      console.error('Error adding lecture:', error.response || error);
                  ...
                  <div className="bg-white p-6 rounded-lg shadow-md">
                    ...
                    <form onSubmit={handleSubmitLecture}>
                      ...
                      <input
                        ...
                        name="file" // Matches backend field name
