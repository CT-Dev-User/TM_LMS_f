...
const AdminCourses = ({ user }) => {
  ...
  const submitHandler = async (e) => {
    ...
    if (image) formData.append('file', image); // Matches backend expectation

    try {
      console.log('Submitting form with data:', { title, description, category, price, createdBy, duration, image: image ? 'Image selected' : 'No image' });
