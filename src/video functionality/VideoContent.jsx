          ...
          {activeSection === "summary" && (
            <div>
              ...
              <p className="text-gray-600">
                {lecture?.about || "No description available for this title."}
              </p>
          ...
          {activeSection === "live-class" && (
            <div className="text-center">
              ...
              {[
                ...
                <div
                  key={index}
                  className="flex flex-col items-center bg-white p-4 sm:p-6 mb-4 last:mb-0 rounded-lg shadow-md"
                >
                  <h3 className="text-lg sm:text-xl font-semibold text-gray-800 mb-2">
                    {platform} Class
                  </h3>
                  ...
                  <button className="bg-blue-500 text-white px-4 py-2 sm:px-6 sm:py-2.5 rounded-full flex items-center justify-center space-x-2 transition-all duration-300 hover:bg-blue-600">
                    <PiVideoCameraFill />
